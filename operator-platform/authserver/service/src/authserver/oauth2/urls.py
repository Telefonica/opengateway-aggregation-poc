...
from authserver.oauth2.views import AuthorizeView, MetadataView, \
    TokenView, RevokeView, IntrospectView, JWKSetView, UserInfoView, CibaAuthorizeView
...
urlpatterns = [
    ...
    re_path(r'^/authorize/\.well-known/openid-configuration/?$', MetadataView.as_view(), name='authserver-metadata'),
